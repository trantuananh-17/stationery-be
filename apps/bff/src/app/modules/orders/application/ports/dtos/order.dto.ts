...
export interface CouponGrpcDto {
  id: string;
  code: string;
  type: string;
  value: number;
...
export interface GetCouponsGrpcRequest {
  search?: string;
  page?: number;
  limit?: number;
}
...
export interface CouponInputGrpcRequest {
  code: string;
  type: string;
  value: number;
  minOrderAmount?: number;
...
export interface UpdateCouponGrpcRequest {
  couponId: string;
  input: CouponInputGrpcRequest;
}

export interface CouponIdGrpcRequest {
  couponId: string;
}

export interface CouponIdGrpcResponse {
  couponId: string;
}

export interface ValidateCouponGrpcRequest {
  code: string;
  subtotal: number;
}

export interface ValidateCouponGrpcResponse {
  code: string;
  type: string;
  discount: number;
}

export interface ShippingQuoteGrpcRequest {
  amount: number;
}

export interface ShippingQuoteGrpcResponse {
  fee: number;
